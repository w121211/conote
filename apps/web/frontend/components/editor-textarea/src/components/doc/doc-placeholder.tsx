...
import { templateNames } from '../../../../editor-slate/src/templates'
...
export const DocPlaceholder = ({
  ...
  docUid: string
  templateOnClick?: (templateName: string) => void
}) => {
  return (
      ...
      {templateNames.map((name, i) => {
        return (
          <button
            ...
            onClick={() =>
              templateOnClick ? templateOnClick(name) : docTemplateSet(docUid)
            }
          >
