...
const ListRow = ({
  ...
  return (
    <div className="flex justify-between mb-3 pb-2  last:border-none border-b-gray-200 overflow-hidden">
      <Link href={href}>
        ...
        <a className="flex items-center justify-between overflow-hidden">
          ...
          <div className="flex items-center gap-2 text-sm text-gray-500">
            ...
            <div className="flex flex-col">
              <h3 className="flex-shrink-0 truncate text-gray-900 font-medium">{title}</h3>
              {summary && <span className="whitespace-nowrap text-gray-500 text-xs font-normal">{summary}</span>}
            </div>
            {rate && (
              <span
