...
const Popover = ({ children, hideBoard, subTitle, mask, buttons, topRightBtn }: PopoverProps): JSX.Element | null => {
  ...
  return (
    <div className="fixed flex justify-center top-0 left-0 w-screen h-screen z-50" role="dialog">
      ...
      <div className="relative  flex flex-col w-[90vw] h-fit max-h-[90vh] sm:w-fit sm:min-w-[20vw] sm:max-w-[60vw] sm:max-h-[90vh] mt-[5vh] pl-4 py-2  rounded bg-white shadow-2xl">
        <div className="flex items-center justify-between w-full h-6 sm:h-8 bg-white">
          <div>
            {/* <span
        ...
        <div className="scrollbar overflow-y-scroll mb-4 sm:pl-8 sm:pr-12 sm:mb-8">{children}</div>
