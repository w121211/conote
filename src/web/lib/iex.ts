/**
 * 1. 取得所有symbols: https://cloud.iexapis.com/stable/ref-data/iex/symbols?token=IEX_TOKEN
 * 2. 取得每個symbol的profile: https://cloud.iexapis.com/stable/stock/aapl/company?token=IEX_TOKEN
 * 可以單獨執行: npx ts-node src/models/ticks.ts
 */
...
// function fetchAndSaveTicks(symbol: PA.Symbol, range = 'd5') {
//   /**
