...
export const nestedCards: { head: CardHeadContent; body: CardBodyContent }[] = [
  {
    head: {
      ...
      value: { template: '::Ticker', title: '[[瑞典央行數字貨幣白皮書]]', keywords: [''], tags: [''], pinPrice: true },
    },
    body: {
      root: {
        head: '[[瑞典央行數字貨幣白皮書]]',
        ...
        children: [
          { head: '[!]', freeze: true, id: 453, userIds: ['bot'], timestamp: 1625159031514 },
          {
            head: '[?]',
            freeze: true,
            id: 452,
            ...
            children: [
              {
                ...
                freeze: true,
                hashtags: [{ userId: 'bot', boardId: 26, boardStatus: 'ACTIVE', text: '#Answer' }],
                id: 461,
                boardId: 26,
                pollId: 26,
                userIds: ['bot'],
          ...
          { head: '[*]', freeze: true, id: 456, userIds: ['bot'], timestamp: 1625159031514 },
          { head: '[+]', freeze: true, id: 451, userIds: ['bot'], timestamp: 1625159031514 },
          { head: '[-]', freeze: true, id: 455, userIds: ['bot'], timestamp: 1625159031514 },
          {
            head: '[錢的定義]',
            op: 'create',
            children: [
  ...
  },
  {
    head: {
      ...
      value: { template: '::Ticker', title: '[[數字貨幣]]', keywords: [''], tags: [''], pinPrice: true },
    },
    body: {
      root: {
        head: '[[數字貨幣]]',
        ...
        children: [
          { head: '[!]', freeze: true, id: 457, userIds: ['bot'], timestamp: 1625159031522 },
          {
            head: '[?]',
            freeze: true,
            id: 459,
            ...
            children: [
              {
                ...
                pollChoices: ['BUY', 'SELL', 'WATCH'],
                freeze: true,
                hashtags: [{ userId: 'bot', boardId: 27, boardStatus: 'ACTIVE', text: '#Answer' }],
                id: 462,
                boardId: 27,
                pollId: 27,
                userIds: ['bot'],
          ...
          { head: '[*]', freeze: true, id: 460, userIds: ['bot'], timestamp: 1625159031522 },
          { head: '[+]', freeze: true, id: 454, userIds: ['bot'], timestamp: 1625159031522 },
          { head: '[-]', freeze: true, id: 458, userIds: ['bot'], timestamp: 1625159031522 },
        ],
      },
    },
  },
...
export const head: CardHeadContent = {
  root: {
    ...
    children: [
      ...
      { head: 'keywords', body: '', keyvalue: true, op: 'create', id: 428, userIds: ['bot'], timestamp: 1625159030863 },
      { head: 'tags', body: '', keyvalue: true, op: 'create', id: 427, userIds: ['bot'], timestamp: 1625159030863 },
    ],
    id: 425,
    userIds: ['bot'],
    timestamp: 1625159030863,
...
export const body: CardBodyContent = {
  root: {
    ...
    children: [
      { head: '[!]', freeze: true, id: 472, userIds: ['bot'], timestamp: 1625160416507 },
      {
        head: '[?]',
        freeze: true,
        id: 475,
        ...
        children: [
          {
            ...
            pollChoices: ['BUY', 'SELL', 'WATCH'],
            freeze: true,
            hashtags: [{ userId: 'bot', boardId: 28, boardStatus: 'ACTIVE', text: '#Answer' }],
            id: 476,
            boardId: 28,
            pollId: 28,
            userIds: ['bot'],
      ...
      { head: '[*]', freeze: true, id: 471, userIds: ['bot'], timestamp: 1625160416507 },
      { head: '[+]', freeze: true, id: 474, userIds: ['bot'], timestamp: 1625160416507 },
      { head: '[-]', freeze: true, id: 473, userIds: ['bot'], timestamp: 1625160416507 },
    ],
  },
  nestedCards: [
