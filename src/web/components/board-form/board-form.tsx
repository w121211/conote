...
const BoardForm = ({ initialValue }: { initialValue: FormInputs }) => {
    ...
    <div className={classes.formContainer}>
      <form className={classes.form} onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className={classes.section}>
          <div className={classes.choiceWrapper}>
            ...
            <div className={classes.radioWrapper}>
              <label className={classes.radioLabel}>
                <input {...register('choice')} type="radio" value="buy" />
              ...
              <label className={classes.radioLabel}>
                <input {...register('choice')} type="radio" value="sell" />
                <svg width="32" height="32" viewBox="-4 -4 39 39" aria-hidden="true" focusable="false">
                  {/* <!-- The background --> */}
                  <rect
                    className={classes.checkBg}
              ...
              <label className={classes.radioLabel}>
                <input {...register('choice')} type="radio" value="looking" />
                <svg width="32" height="32" viewBox="-4 -4 39 39" aria-hidden="true" focusable="false">
                  {/* <!-- The background --> */}
                  <rect
                    className={classes.checkBg}
          ...
          <input type="text" {...register('lines')} placeholder="留言..." />
        </div>
      </form>
    </div>
  )
