            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, got_1["default"].get('https://youtube.com/get_video_info', {
                                searchParams: { video_id: vid }
                            })];
                    case 1:
                        resp = _a.sent();
                        p = new URLSearchParams(resp.body).get('player_response');
                        if (p) {
                            j = JSON.parse(p);
                            return [2 /*return*/, {
                                    domain: domain,
                                    ...
                                    resolvedUrl: url,
                                    srcType: index_1.SrcType.VIDEO,
                                    srcId: vid !== null && vid !== void 0 ? vid : '',
